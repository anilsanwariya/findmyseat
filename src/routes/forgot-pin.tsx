      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4">
        <div className="w-full max-w-md">
          ...
          <GlassPanel className="p-6">
            <div className="mb-4 inline-flex size-10 items-center justify-center rounded-lg bg-violet/15 text-violet">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="bg-panel border-panel-border pl-9"
              ...
              >
                {devCode && (
                  <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-3 text-xs text-amber-300">
                    <span className="font-semibold">Dev preview code:</span>{" "}
                    <span className="font-mono">{devCode}</span> — hook up Lovable Emails to send this by mail.
                  </div>
                )}
                <div className="space-y-2">
