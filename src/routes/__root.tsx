...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lexicon — Library & Study Space Management" },
      ...
      { property: "og:title", content: "Lexicon — Library & Study Space Management" },
      { property: "og:description", content: "Run your library like a modern SaaS: branches, sections, seats, allocations, payments, and marketplace discovery." },
