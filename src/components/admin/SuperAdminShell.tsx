...
import { LayoutDashboard, Building2, CreditCard, LogOut, ShieldCheck, Menu, X, CheckSquare, Tags, ArrowRightLeft } from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { to: "/super-admin/transfers", label: "Transfer Requests", icon: ArrowRightLeft },
